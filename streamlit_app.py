...
if len(selected_players) < 10:
    ...
    if st.button("Show SHAP Waterfall Explanation"):
        ...
        shap.kmeans(scaler.transform(df.drop(['Player', 'Season', 'Season Outcome', 'Team','Offense Position', 'Offensive Archetype', 'Defensive Role', 'Stable Avg 2PT Shot Distance','Multiple Teams'], axis=1).values), 10)     
